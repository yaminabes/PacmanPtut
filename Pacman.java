...
public class Pacman extends Sprite{
    ...
    final Image imgPacmanOpen = new Image("images/pacman_2.png");
    final Image imgPacmanClose = new Image("images/pacman_1.png");
    ...
    public Pacman(Model model) {
        super(model);
        speed = 1.5;
        angle = 90; // going down / initial direction
        state = 0;
        ...
        shape.setCenterX(x);
        shape.setCenterY(y);
        shape.setRadius(squareSize/3);
        shape.setFill(new ImagePattern(imgPacmanOpen));  
    }
    ...
    public void update() {
        ...
        if (state == 0) {
            ...
            Circle shape1 = new Circle(x,y,squareSize/3);
